    ...
    <div className="member-dashboard-container container-fluid px-4" style={{ overflowX: 'auto', width: '100%' }}>
      <div className="row gx-4">
        <div className="col-lg-8 mb-4">
          <div className="card tasks-card p-3 h-100 d-flex flex-column justify-content-between">
            <h2 className="mb-3">My Assigned Tasks</h2>

            <div className="flex-grow-1">
              <div className="table-responsive">
                {tasks.length === 0 ? (
                  <div className="text-center text-muted py-4">No tasks assigned to you yet.</div>
                ) : (
                  <table className="table table-bordered table-hover mb-0 rounded-top-4 overflow-hidden">
            ...
            {tasks.length > 0 && (
              <div className="text-end mt-3">
                <button className="btn btn-primary btn-md" onClick={handleAssignedTaskClick}>
                  View All
                </button>
              </div>
            )}
        ...
        <div className="col-lg-4 mb-4">
          <div className="card status-card p-3 h-100 text-center">
            ...
            {tasks.length === 0 ? (
              <div className="text-muted my-auto py-5">No task status data available.</div>
            ) : (
              <>
